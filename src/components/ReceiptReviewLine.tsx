      ...
      <div className="flex flex-wrap items-center gap-2">
        {needsReview && line.matchedItem ? (
          <form action={setLineMatch}>
            ...
            <button type="submit" className="rounded bg-gray-900 px-3 py-1 text-xs text-white hover:bg-gray-700">
              Confirm
            </button>
          </form>
        ) : null}
      ...
      {creating ? (
        <form action={createAction} className="space-y-2 rounded border border-gray-200 bg-gray-50 p-3">
          ...
          <div className="flex items-center gap-4">
            ...
            <button type="submit" className="ml-auto rounded bg-gray-900 px-3 py-1 text-xs text-white hover:bg-gray-700">
              Create &amp; match
            </button>
          </div>
        </form>
